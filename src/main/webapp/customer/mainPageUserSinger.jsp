    ...
    <div class="col-9" style="background-color: #170f24">
        <div class="row">
            ...
            <div class="col-3" style="text-align: center; border-radius: 5%;border: 5px solid #170f24 ;background-color: #170f24;padding: 10px;">
                <a href="/Song?action=playSongSinger&id=5" style="text-decoration: none"><img src="../picture/maxresdefault.jpeg" alt="..." style="width:90%;height: 180px;border-radius: 5%">
            ...
            <div class="col-3" style="text-align: center; border-radius: 5%;border: 5px solid #170f24 ;background-color: #170f24;padding: 10px;">
                <a href="/Song?action=playSongSinger&id=1" style="text-decoration: none"><img src="https://photo-zmp3.zmdcdn.me/banner/2/f/2/e/2f2ee9e31054d0894da4d2a3495bb54c.jpg" alt="..." style="width:90%;height: 180px;border-radius: 5%">
            ...
            <div class="col-3" style="text-align: center; border-radius: 5%;border: 5px solid #170f24 ;background-color: #170f24;padding: 10px;">
                <a href="/Song?action=playSongSinger&id=2" style="text-decoration: none"><img src="https://data.chiasenhac.com/data/cover/166/165383.jpg" alt="..." style="width:90%;height: 180px;border-radius: 5%">
            ...
            <div class="col-3" style="text-align: center; border-radius: 5%;border: 5px solid #170f24 ;background-color: #170f24;padding: 10px;">
                <a href="/Song?action=playSongSinger&id=3" style="text-decoration: none"><img src="https://i.ytimg.com/vi/B9PDYlaV84w/maxresdefault.jpg" alt="..." style="width:90%;height: 180px;border-radius: 5%">
            ...
            <div class="col-3" style="text-align: center; border-radius: 5%;border: 5px solid #170f24 ;background-color: #170f24;padding: 10px;">
                <a href="/Song?action=playSongSinger&id=4" style="text-decoration: none"><img src="https://i.ytimg.com/vi/LaxkmhiECfM/maxresdefault.jpg" alt="..." style="width:90%;height: 180px;border-radius: 5%">
            ...
            <div class="col-3" style="text-align: center; border-radius: 5%;border: 5px solid #170f24 ;background-color: #170f24;padding: 10px;">
                <a href="/Song?action=playSongSinger&id=10" style="text-decoration: none"><img src="https://i.scdn.co/image/ab67616d0000b27311011e6d4d2fc5969ba8ab68" alt="..." style="width:90%;height: 180px;border-radius: 5%">
                    <b><p style="text-align: center; color: white;padding: 13px";>Hết Nhạc Con Về</p></b>
                    <p style="text-align: center; color: white"> Cukak </p></a>
            </div>
            <div class="col-3" style="text-align: center; border-radius: 5%;border: 5px solid #170f24 ;background-color: #170f24;padding: 10px;">
                <a href="/Song?action=playSongSinger&id=9" style="text-decoration: none"><img src="https://navicdn.com/karaokeviet/images/2019/03/05/i4XWOJwUr5onCXarVFBnf8Dt8VDhqYiLAjYGngWy.jpeg" alt="..." style="width:90%;height: 180px;border-radius: 5%">
            ...
            <div class="col-3" style="text-align: center; border-radius: 5%;border: 5px solid #170f24 ;background-color: #170f24;padding: 10px;">
                <a href="/Song?action=playSongSinger&id=11" style="text-decoration: none"><img src="https://i.ytimg.com/vi/iODOOoONVew/maxresdefault.jpg" alt="..." style="width:90%;height: 180px;border-radius: 5%">
