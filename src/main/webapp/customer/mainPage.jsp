...
<div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel" style="text-align: center;background-color: #170f24; width: 100%">
...
<div class="row">
  ...
  <div class="col-9" style="background-color: #170f24">
    <div class="row">
      ...
      <div class="col-3" style="text-align: center; border-radius: 5%;border: 5px solid #170f24 ;background-color: #170f24;padding: 10px;">
        <a href="/Song?action=playSong&id=1" style="text-decoration: none"><img src="https://photo-zmp3.zmdcdn.me/banner/2/f/2/e/2f2ee9e31054d0894da4d2a3495bb54c.jpg" alt="..." style="width:90%;height: 180px;border-radius: 5%">
      ...
      <div class="col-3" style="text-align: center; border-radius: 5%;border: 5px solid #170f24 ;background-color: #170f24;padding: 10px;">
        <a href="/Song?action=playSong&id=2" style="text-decoration: none"><img src="https://data.chiasenhac.com/data/cover/166/165383.jpg" alt="..." style="width:90%;height: 180px;border-radius: 5%">
      ...
      <div class="col-3" style="text-align: center; border-radius: 5%;border: 5px solid #170f24 ;background-color: #170f24;padding: 10px;">
        <a href="/Song?action=playSong&id=3" style="text-decoration: none"><img src="https://i.ytimg.com/vi/B9PDYlaV84w/maxresdefault.jpg" alt="..." style="width:90%;height: 180px;border-radius: 5%">
      ...
      <div class="col-3" style="text-align: center; border-radius: 5%;border: 5px solid #170f24 ;background-color: #170f24;padding: 10px;">
        <a href="/Song?action=playSong&id=4" style="text-decoration: none"><img src="https://i.ytimg.com/vi/LaxkmhiECfM/maxresdefault.jpg" alt="..." style="width:90%;height: 180px;border-radius: 5%">
      ...
      <div class="col-3" style="text-align: center; border-radius: 5%;border: 5px solid #170f24 ;background-color: #170f24;padding: 10px;">
        <a href="/Song?action=playSong&id=10" style="text-decoration: none"><img src="https://i.scdn.co/image/ab67616d0000b27311011e6d4d2fc5969ba8ab68" alt="..." style="width:90%;height: 180px;border-radius: 5%">
        <b><p style="text-align: center; color: white;padding: 13px";>Hết Nhạc Con Về</p></b>
          <p style="text-align: center; color: white"> Cukak </p></a>
      </div>
      <div class="col-3" style="text-align: center; border-radius: 5%;border: 5px solid #170f24 ;background-color: #170f24;padding: 10px;">
        <a href="/Song?action=playSong&id=9" style="text-decoration: none"><img src="https://navicdn.com/karaokeviet/images/2019/03/05/i4XWOJwUr5onCXarVFBnf8Dt8VDhqYiLAjYGngWy.jpeg" alt="..." style="width:90%;height: 180px;border-radius: 5%">
      ...
      <div class="col-3" style="text-align: center; border-radius: 5%;border: 5px solid #170f24 ;background-color: #170f24;padding: 10px;">
        <a href="/Song?action=playSong&id=11" style="text-decoration: none"><img src="https://i.ytimg.com/vi/iODOOoONVew/maxresdefault.jpg" alt="..." style="width:90%;height: 180px;border-radius: 5%">
    ...
    <div class="row">
      ...
      <div class="col-3" style="text-align: center; border-radius: 5%;border: 5px solid #170f24 ;background-color: #170f24;padding: 10px;">
        ...
        <b><p style="text-align: center; color: white;padding: 13px";>Nhạc Cho Chủ Nhật</p></b>
      ...
      <div class="col-3" style="text-align: center; border-radius: 5%;border: 5px solid #170f24 ;background-color: #170f24;padding: 10px;">
        ...
        <b><p style="text-align: center; color: white;padding: 13px";>Nhạc Phim Hàn</p></b>
        <p style="text-align: center; color: white"></p>
      </div>
    </div>
    <div class="row">
      ...
      <div class="col-3" style="text-align: center; border-radius: 5%;border: 5px solid #170f24 ;background-color: #170f24;padding: 10px;">
        ...
        <b><p style="text-align: center; color: white;padding: 13px";>SooBin</p></b>
        <p style="text-align: center; color: white"></p>
      </div>
      <div class="col-3" style="text-align: center; border-radius: 5%;border: 5px solid #170f24 ;background-color: #170f24;padding: 10px;">
        ...
        <b><p style="text-align: center; color: white;padding: 13px";>Min</p></b>
        <p style="text-align: center; color: white"></p>
      </div>
      <div class="col-3" style="text-align: center; border-radius: 5%;border: 5px solid #170f24 ;background-color: #170f24;padding: 10px;">
        ...
        <b> <p style="text-align: center; color: white;padding: 13px";>Erik</p></b>
        <p style="text-align: center; color: white"></p>
      </div>
    </div>
  </div>
  ...
  <div class="col-12">
    <footer class="text-center text-white" style="background-color: #170f24;">
      ...
      <div class="container pt-4">
        ...
        <section class="mb-4">
          <div class="container">
            <a target="_blank" href="https://www.apple.com/itunes/"> <i class="fa fa-apple" id="apple"></i></a>
            <a target="_blank" href="https://twitter.com/"><i class="fa fa-twitter" id="twitter"></i></a>
            <a target="_blank" href="https://github.com/huytran119411/git-group"><i class="fa fa-github-square github" id="github"></i></a>
            <a target="_blank" href="https://www.facebook.com/H%E1%BA%BFt-Nh%E1%BA%A1c-Con-V%E1%BB%81-110225961780479"><i class="fa fa-facebook-square" id="facebook"></i></a>
          </div>
        </section>
        <!-- Section: Social media -->
      </div>
