...
<div class="row">
  ...
  <div class="col-9" style="background-color: #170f24">
    <div class="row">
      ...
      <div class="col-3" style="text-align: center; border-radius: 5%;border: 5px solid #170f24 ;background-color: #170f24;padding: 10px;">
        <img src="https://i.scdn.co/image/ab67616d0000b27311011e6d4d2fc5969ba8ab68" alt="..." style="width:90%;height: 180px;border-radius: 5%">
        <b><p style="text-align: center; color: white;padding: 13px";>Hết Nhạc Con Về</p></b>
        <p style="text-align: center; color: white"> Cukak </p>
      </div>
      <div class="col-3" style="text-align: center; border-radius: 5%;border: 5px solid #170f24 ;background-color: #170f24;padding: 10px;">
        <img src="https://navicdn.com/karaokeviet/images/2019/03/05/i4XWOJwUr5onCXarVFBnf8Dt8VDhqYiLAjYGngWy.jpeg" alt="..." style="width:90%;height: 180px;border-radius: 5%">
        <b><p style="text-align: center; color: white;padding: 13px";>Mãi Mãi Bên Nhau</p></b>
        <p style="text-align: center; color: white"> Noo Phước Thịnh </p>
      </div>
      <div class="col-3" style="text-align: center; border-radius: 5%;border: 5px solid #170f24 ;background-color: #170f24;padding: 10px;">
        <img src="https://i.ytimg.com/vi/iODOOoONVew/maxresdefault.jpg" alt="..." style="width:90%;height: 180px;border-radius: 5%">
        <b><p style="text-align: center; color: white;padding: 13px";>Đồi Thông Hai Mộ</p></b>
        <p style="text-align: center; color: white"> Hoàng Châu </p>
      </div>
    </div>
    <div class="row">
      <br>
